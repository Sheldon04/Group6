...
用法：
python collectingfaces.py --id 106 --imagedir C:/Users/lenovo/Desktop/mosr/collection/images
...
# 全局参数
audio_dir = 'C:/Users/lenovo/Desktop/mosr/collection/audios'
...
for action in action_list:
    ...
    for i in range(15):
        ...
        draw.text((int(image.shape[1]/2), 30), action_name,
                 font=ImageFont.truetype('NotoSansCJK-Black.ttc', 40),fill=(255,0,0)
                  ) # linux
