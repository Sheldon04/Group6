...
export default {
  ...
  methods: {
    ...
    handleClick (row) {
      ...
      const auth = 'Token ' + localStorage.getItem('token')
      const header = {'Authorization': auth}
      // http://47.106.148.74:8080/api/emolistuser/detail http://127.0.0.1:8000/api/attacklistuser/detail
      axios.post('http://47.106.148.74:8080/api/event/interaction/detail', formData, {'headers': header}).then(response => {
